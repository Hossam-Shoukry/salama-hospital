...
<footer id="callus"
  ...
  <!--Copyright section-->
  <div class="text-center d-block text-center">
    <span class="text-h6 d-inline-block">يمكن التواصل من خلال الارقام التالية</span>
    <div>
        <v-btn size="60" variant="text">
  ...
  <div
    class="w-full p-4 text-center text-h6 font-bold mb-5"
    style="background-color: rgba(0, 0, 0, 0.2)">
   حقوق الطبع والنشر محفوظة
    <a class="text-whitehite" href="https://tailwind-elements.com/"
      > : تم تصميم هذا القالب بواسطة المهندس حسام الدين شكرى </a
    >
  </div>
</footer>
</template>
